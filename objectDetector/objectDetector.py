...
class objectDetector:
    #modelPath = "/home/csl-mini-pc/Desktop/petropoulakis/catkin_ws/src/visual_servo/src/objectDetector/model/frozen_inference_graph.pb", labelPath = "/home/csl-mini-pc/Desktop/petropoulakis/catkin_ws/src/visual_servo/src/objectDetector/annotations/label_map.pbtxt"
    def __init__(self, modelPath = "../objectDetector/model/frozen_inference_graph.pb", labelPath = "../objectDetector/annotations/label_map.pbtxt", minAreaBox=1100, maxAreaBox=30000, offset=10):
        ...
        self.offset = offset  # Generate bigger box from the detected to secure that leader lies inside   
        self.debug = True
    ...
    @staticmethod
    # Result box to pixel coordinates #
...
if  __name__ == '__main__':
    ...
    '''
    # Read images #
    files = os.listdir("/home/petropoulakis/Desktop/TensorFlow/workspace/robot_detection/images/fine_aug/")
    hashes = []
    images = []
    for file in files:
    ...
    for image in images:
        i += 1
        print(i)
        imageNp = objectDetector.imageToNumpy(Image.open("/home/petropoulakis/Desktop/TensorFlow/workspace/robot_detection/images/fine_aug/" + image))
        imageExpand = np.expand_dims(imageNp, axis=0)
        ...
        if sum(score >= 0.5 for score in result["detection_scores"]) > 1 or result["detection_scores"][0] < 0.5:
            pioneerDetector.visualize(imageNp,  result)
            img = Image.fromarray(imageNp, 'RGB')
            img.save("/home/petropoulakis/Desktop/saved/" + image)
            count += 1
